...
erDiagram
    ...
    USER ||--|{ FAVORITE : "user_id(DELETE CASCADE)"
    USER ||--|{ NOTE : "user_id(DELETE CASCADE)"
    USER ||--|{ REPORT : "user_id(DELETE CASCADE)"
    USER ||--|{ FOLLOWS : "user_id(DELETE CASCADE)"
    USER ||--|{ FOLLOWS : "following_user_id(DELETE CASCADE)"
    USER ||--|{ FCM_TOKEN : "user_id(DELETE CASCADE)"
